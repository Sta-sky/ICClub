# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2019-12-26 01:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('act_img', models.ImageField(default=None, upload_to='', verbose_name='活动图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('activity', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='activ.Activity', verbose_name='活动')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_url', models.ImageField(null=True, upload_to='', verbose_name='默认图片')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portrait', models.ImageField(default='user.png', upload_to='', verbose_name='头像路径')),
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('interest', models.ManyToManyField(default='跑步', to='activ.InterestTag', verbose_name='爱好标签')),
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ManyToManyField(to='activ.UserInfo', verbose_name='参与者'),
        ),
        migrations.AddField(
            model_name='activity',
            name='tag',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='activ.InterestTag', verbose_name='活动标签'),
        ),
        migrations.AddField(
            model_name='activity',
            name='user',
