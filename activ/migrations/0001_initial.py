    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('interest', models.ManyToManyField(default=None, to='activ.InterestTag', verbose_name='爱好标签')),
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ManyToManyField(default=None, to='activ.UserInfo', verbose_name='参与者'),
        ),
        migrations.AddField(
            model_name='activity',
            name='tag',
