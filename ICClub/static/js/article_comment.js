    ...
    success:function(response){
        if(response.code==200){
            ...
            for(var i=0;i<data.length;i++){
                ...
                html+='<a href="user_info.html?id=' + cmt.user_id+'><p class="nickname">'+cmt.nickname+'</p></a>';
                ...
                for(var j=0;j<reviews.length;j++){
                    ...
                    html+='<a href="user_info.html?id=' + rev.a_user_id+'"><p class="a-nickname">'+rev.a_nickname+'</p></a>';
                    html+='<p style="color: black;font-size: 14px;">回复</p>';
                    html+='<a href="user_info.html?id=' + rev.b_user_id+'><p class="b-nickname">'+rev.b_nickname+'</p></a></div>';
